...
import Thumb1 from '../assets/images/resource/testi-thumb1-1.png';
import Thumb2 from '../assets/images/resource/testi-thumb1-2.png';
      ...
      <div className="row">
        ...
        <div className="col-lg-6 col-xl-6 product-info">
          ...
          <div className="product-details__buttons">
            <Link to="/shop-cart" className="btn-style-one">
            ...
            <Link to="/shop-product-details" className="btn-style-one">
              <span className="left-arrow"><i className="fa-regular fa-arrow-up-right"></i></span>
          ...
          <div className="product-details__social">
            <div className="title"><h3 className="h3 mb-3 mb-md-0">Share with friends</h3></div>
            ...
            <div className="customer-comment">
                        ...
                        <div className="single-comment-box">
                            <div className="inner-box">
                                ...
                                <div className="inner">
                                    ...
                                    <h5>Jon D. William, <span>15 May, 2026 . 4:00 pm</span></h5>
                        ...
                        <div className="single-comment-box">
                            <div className="inner-box">
                                ...
                                <div className="inner">
                                    ...
                                    <h5>Aleesha Brown, <span>15 May, 2026 . 8:00 pm</span></h5>
                                    <p>Aliquam hendrerit a augue insuscipit. Etiam aliquam massa quis des mauris commodo.</p>
                                </div>
                            </div>
                        </div>
              ...
              <div className="comment-box">
                ...
                <form id="contact_form" action="/" method="get">
                  <div className="mb-3">
                    <textarea name="Emessage" className="form-control required" rows="7" placeholder="Enter Message"></textarea>
                  </div>
                  <div className="row">
                    <div className="col-sm-6">
                      <div className="mb-3">
                        <input name="Ename" className="form-control" type="text" placeholder="Enter Name" />
                      </div>
                    </div>
                    <div className="col-sm-6">
                      <div className="mb-3">
                        <input name="Eemail" className="form-control required email" type="email" placeholder="Enter Email" />
                      </div>
                    </div>
                  </div>
