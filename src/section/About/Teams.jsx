          ...
          <div className="container">
            ...
            <div className="row g-24">
              <div className="col-xl-3 col-md-6">
                <div className="team-block">
                  <div className="inner-block">
                    <div className="image"><img src={TeamImage1} alt=""/></div>
              ...
              <div className="col-xl-3 col-md-6">
                <div className="team-block">
                  <div className="inner-block">
                    <div className="image"><img src={TeamImage2} alt=""/></div>
                    <div className="content">
                      <div className="info">
              ...
              <div className="col-xl-3 col-md-6">
                <div className="team-block">
                  <div className="inner-block">
                    <div className="image"><img src={TeamImage3} alt=""/></div>
                    <div className="content">
                      <div className="info">
              ...
              <div className="col-xl-3 col-md-6">
                <div className="team-block">
                  <div className="inner-block">
                    <div className="image"><img src={TeamImage4} alt=""/></div>
                    <div className="content">
                      <div className="info">
